...
const Navbar = () => {
  ...
  const { onOpenReview } = useCreateReviewModal()
  const {onOpenDaftar} = useCreateDaftarModal()
  ...
  const links = [{
    ...
    label: "Unit dan Organisasi", 
    href: "/UnitdanOrganisasi", 
    active: pathName === "/UnitdanOrganisasi"
  },
  {
    label: "Activities", 
    href: "/activity", 
            ...
            <div className="flex items-center justify-end gap-5">
                ...
                {user ? (
                  <div className="gap-4 flex items-center justify-end">
                    {pathName === "/review" ? (
                      <Button variant="default" onClick={() => onOpenReview()}>
                        Add Review
                      </Button>
                    ) : (
                      <></>
                    )}
                    {pathName === "/UnitdanOrganisasi" ? (
                     <Button variant="default" onClick={() => onOpenDaftar()}>
                        Add Unit or Organization
                     </Button>
                    ):(<></>)
                    }
                    <DropdownMenu>
